...
Route::get('/consulting', [ConsultingController::class, 'index'])->name('consulting.index')->middleware('auth');
// Route::resource('consultings', ArtikelController::class)->middleware('auth');
